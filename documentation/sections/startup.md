...
| `SetTradeOffer`             | integer \| integer \| integer \| integer \| integer \| integer \| integer | x \| y \| trade index \| good offered \| good offered count \| good demanded \| good demanded count | Create trade offer in house on given position with specified goods.                   |
...
|        Value         | Value meaning                                                                                              |
|:--------------------:|:-----------------------------------------------------------------------------------------------------------|
| `XXXXXX`<sup>2</sup> | Cutscene stored in file path `data_m\c1_txt\c1_fhll\txt_XXXXXX.txt`<sup>1</sup> relative to `Cultures.exe` |
↑ <sup>2</sup>Where `XXXXXX` are any six decimal digits.
