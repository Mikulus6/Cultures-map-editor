...
|:----------------------------|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------|
| `StartPos`                  | integer \| integer \| integer                                             | player \| x \| y                                                                                                            | Set starting camera position for given player.                                                                             |
...
| `SetCreature`               | integer \| integer \| integer \| integer \| integer                       | player \| job type \| x \| y \| quantity                                                                                    | Set creatures in specified quantity for given player with given job on given position.                                     |
| `SetCreatureName`           | integer \| integer \| integer                                             | x \| y \| string ID                                                                                                         | Set name of creature on given starting position.                                                                           |
...
| `AddHouseStock`             | integer \| integer \| string \| integer                                   | x \| y \| good type \| good count<sup>1</sup>                                                                               | Add goods to house on given position.                                                                                      |
| `SetCreatureHome`           | integer \| integer \| integer \| integer                                  | x (creature) \| y (creature) \| x<sup>2</sup> (home) \| y<sup>2</sup> (home)                                                | Assign creature to home by given positions.                                                                                |
| `SetCreatureWork`           | integer \| integer \| integer \| integer                                  | x (creature) \| y (creature) \| x<sup>2</sup> (work) \| y<sup>2</sup> (work)                                                | Assign creature to workplace by given positions.                                                                           |
...
| `SetTradeOffer`             | integer \| integer \| integer \| integer \| integer \| integer \| integer | x \| y \| trade index \| good offered \| good offered count<sup>3</sup> \| good demanded \| good demanded count<sup>3</sup> | Create trade offer in house on given position with specified goods.                                                        |
...
| `Particles_AddFishes`       | float \| float \| int \| float \| float                                   | x \| y \| quantity \| linear speed factor \| power speed factor                                                             | Set fish particles in specified quantity on given position. Speed of each fish is determined by speed factors<sup>4</sup>. |
| `Particles_AddBirds`        | float \| float \| int \| float \| float                                   | x \| y \| quantity \| linear speed factor \| power speed factor                                                             | Set bird particles in specified quantity on given position. Speed of each bird is determined by speed factors<sup>4</sup>. |
...
↑ <sup>1</sup>Goods quantities in houses cannot exceed the value `200`,
otherwise their counts will be truncated to `200`.  
↑ <sup>2</sup>These coordinates must satisfy the following equation: `y mod 4 = 2·(x mod 2)`  
↑ <sup>3</sup>Goods quantities in trade offers cannot exceed the value `8`,
otherwise the trade offer will not work correctly.  
↑ <sup>4</sup>Speed of `n`-th particle-related animal (counting `n` from zero)
is proportional to the formula `A·Bⁿ`, where `A` is the linear speed factor
and `B` is the power speed factor.  
...
|        Value         | Value meaning                                                                                              |
|:--------------------:|:-----------------------------------------------------------------------------------------------------------|
| `XXXXXX`<sup>5</sup> | Cutscene stored in file path `data_m\c1_txt\c1_fhll\txt_XXXXXX.txt`<sup>5</sup> relative to `Cultures.exe` |

↑ <sup>5</sup>Where `XXXXXX` are any six decimal digits.